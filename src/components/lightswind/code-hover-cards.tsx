...
const CodeHoverCards: FC<CodeHoverCardsProps> = ({
  cards = DEFAULT_CARDS,
  className,
  cardClassName,
  maskRadius = 300,
  ...
  const handleTouchMove = (e: TouchEvent<HTMLDivElement>, cardId: string) => {
                  ...
                  <div
                    ...
                    style={{
                      ...
                      maskImage:
                        'radial-gradient(' +
                        maskRadius +
                        'px circle at ' + position.x + 'px ' + position.y + 'px, #000 20%, rgba(0, 0, 0, 0.25), transparent)',
