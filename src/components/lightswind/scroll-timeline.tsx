...
export const ScrollTimeline = ({
  ...
  const progressValue = smoothScroll ? smoothProgress : scrollYProgress;
  const progressHeight = useTransform(progressValue, [0, 1], ['0%', '100%']);
  ...
  useEffect(() => {
    const unsubscribe = progressValue.onChange((v) => {
    ...
    return () => unsubscribe();
  }, [progressValue, events.length, activeIndex]);
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    viewport={{ once: false, margin: '-100px' }}
                    style={
                      parallaxIntensity > 0 ? { y: parallaxOffset } : undefined
                    }
                  >
