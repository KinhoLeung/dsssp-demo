...
export type AbstractlySliderHorizontalHandleBgProps = React.SVGProps<SVGSVGElement> & {
  idPrefix?: string
  title?: string
}

export function AbstractlySliderHorizontalHandleBg({
  idPrefix,
  title,
  ...props
}: AbstractlySliderHorizontalHandleBgProps) {
  const autoIdPrefix = React.useMemo(
    () => `ab-slider-horizontal-handle-${Math.random().toString(36).slice(2, 9)}`,
    []
  )
  ...
  return (
    ...
    >
      ...
      <g transform="translate(54 0) rotate(90)">
