  ...
  const handleImport = useCallback(
    async (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      try {
        ...
        if (!data.db) {
          throw new Error(
            t('deviceDemo.import.invalidConfigMissingDb', {
        ...
        if (data.deviceId && currentDeviceId && data.deviceId !== currentDeviceId) {
          setImportValidation({
            ...
            message: t('deviceDemo.import.deviceMismatch', {
        ...
        if (importMajor && currentMajor && importMajor !== currentMajor) {
          setImportValidation({
            ...
            message: t('deviceDemo.import.criticalVersionMismatch', {
              importMajor,
              currentMajor,
              defaultValue:
        ...
        if (data.firmwareVersion && currentVersion && data.firmwareVersion !== currentVersion) {
          setImportValidation({
            ...
            message: t('deviceDemo.import.versionMismatch', {
        ...
        alert(
          t('deviceDemo.import.importFailed', {
